...
public class CommandSequences {
	...
	public Command coralcollectionautotest(CoralDispenserSubsystem coralDispenserSubsystem) {
		return new SequentialCommandGroup(new ParallelCommandGroup(new CollectCoralCmd(coralDispenserSubsystem),
				coralDispenserSubsystem.seecoral == true ? new SwerveDriveToPointCmd(null, reefNode('C')) : null));
	}
	...
	// Elevator Commands
	public Command placeOnReef(ElevatorSubsystem elevatorSubsystem, CoralDispenserSubsystem coralDispenserSubsystem,
			double elevatorHeight) {
		return new SequentialCommandGroup(new AutoElevatorCommand(elevatorSubsystem, elevatorHeight),
				new ParallelDeadlineGroup(new AutoCoralDispenseCommand(coralDispenserSubsystem),
	...
	public Command driveForward(SwerveSubsystem swerveSubsystem,
		...
		return new SwerveDriveToPointCmd(swerveSubsystem,
				simplePose(currentPos.getX() - 1, currentPos.getY(), currentPos.getRotation().getDegrees()));
	}
