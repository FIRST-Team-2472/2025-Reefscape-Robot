...
public class CommandSequences {
    ...
    return new SequentialCommandGroup(
        new ParallelCommandGroup(
            ...
            coralDispenserSubsystem.seecoral == true
                ? new SwerveDriveToPointCmd(null, reefNode('C'))
                : null));
  }
  ...
  public Command driveForward(
      SwerveSubsystem swerveSubsystem, PositionFilteringSubsystem positionFilteringSubsystem) {
    ...
    return new SwerveDriveToPointCmd(
        swerveSubsystem,
        simplePose(
            currentPos.getX() - 1, currentPos.getY(), currentPos.getRotation().getDegrees()));
  }
