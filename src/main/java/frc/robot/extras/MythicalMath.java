...
public class MythicalMath {
    ...
    /**
     * mirrors a starting pose around a coordinate. very useful for changing a coordinate from blue
     * alliance to red alliance. The angle will also flip 180 degrees
     *
     * @param startingPose
    ...
    public static Pose2d mirrorPoseAround(Pose2d startingPose, double pivotX, double pivotY) {
        ...
        return new Pose2d(
                mirroredX,
                mirroredY,
                Rotation2d.fromRadians(-startingPose.getRotation().getRadians()));
    }
    ...
    /**
     * limits a number with an upper and lower limit. Will return the upper or lower limit if the
     * number exceeds that.
     *
     * @param number the number to limit
