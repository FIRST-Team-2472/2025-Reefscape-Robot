...
public class SwerveModule {
	...
	public double getTurningPosition() {
		...
		return (turningMotor.getRotorPosition().getValueAsDouble() * ModuleConstants.kTurningEncoderRot2Rad)
				/ (2 * Math.PI);
	}
	...
	public double getTurningVelocity() {
		// measured in revolutions not radians. easier to understand
		return (driveMotor.getRotorVelocity().getValueAsDouble() * ModuleConstants.kTurningEncoderRPMS2RadPerSec)
				/ (2 * Math.PI);
	}
