...
public class LogManager {
	...
	// Logs at this message should be our most granular and only used for debugging
	// purposes
	public static void debug(String message) {
		if (LoggingConstants.CURRENT_LOG_LEVEL.getSeverity() <= System.Logger.Level.DEBUG.getSeverity()) {
			DataLogManager.log("DEBUG: " + message);
		}
	}

	// we should be more cautious about logging here and avoid too much data - avoid
	// info logging for
	// things tied to constant updates
	public static void info(String message) {
		if (LoggingConstants.CURRENT_LOG_LEVEL.getSeverity() <= System.Logger.Level.INFO.getSeverity()) {
			DataLogManager.log("INFO: " + message);
		}
	}

	public static void warning(String message) {
		if (LoggingConstants.CURRENT_LOG_LEVEL.getSeverity() <= System.Logger.Level.WARNING.getSeverity()) {
			DataLogManager.log("WARNING: " + message);
		}
	}

	public static void error(String message) {
		if (LoggingConstants.CURRENT_LOG_LEVEL.getSeverity() <= System.Logger.Level.ERROR.getSeverity()) {
