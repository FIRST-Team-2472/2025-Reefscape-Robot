...
public class ElevatorSubsystem extends SubsystemBase {
	...
	public ElevatorSubsystem() {
		...
		config.follow(rightElevatorMotor); // change the config to copy the right motor before assigning it to the
		// left
	...
	public void periodic() {
		...
		if (!leftElevatorMotor.hasActiveFault()
			...
			SensorStatus.kElevatorHeight = leftElevatorMotor.getEncoder().getPosition()
					* ElevatorConstants.kElevatorMotorRotationsToInches;
		} else {
			SensorStatus.kElevatorHeight = rightElevatorMotor.getEncoder().getPosition()
					* ElevatorConstants.kElevatorMotorRotationsToInches;
		}
