...
public class AlgaeCollectionSubsystem extends SubsystemBase {
    ...
    public AlgaeCollectionSubsystem() {
        ...
        RobotStatus.kPivotAngle =
                absoluteEncoder.get()
                        * 360; // updating it before its read, converting it to degrees as
        // well
    }
    ...
    public void periodic() {
        ...
        RobotStatus.kPivotAngle =
                (absoluteEncoder.get() * 360 + 180)
                        % 360; // converting it to degrees and offsetting it
        // by 180
