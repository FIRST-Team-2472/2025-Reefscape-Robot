...
public class ClimbSubsystem extends SubsystemBase {
    ...
    public ClimbSubsystem() {
        ...
        RobotStatus.kClimberAngle =
                absoluteEncoder.get()
                        * 360; // setting it before the pid reads it and multiplying it by 360 to
        // convert it from rotations to degrees
    }
