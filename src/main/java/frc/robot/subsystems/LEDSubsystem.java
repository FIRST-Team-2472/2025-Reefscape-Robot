...
public class LEDSubsystem extends SubsystemBase {
	...
	public static LEDSubsystem getInstance() { // Method to allow calling this class and getting the single instance
												// from
	...
	public static enum LEDStatusMode {
		OFF(0), RED(1), GREEN(2), BLUE(3), YELLOW(4), PURPLE(5), CYAN(6), CENTURION(7);
