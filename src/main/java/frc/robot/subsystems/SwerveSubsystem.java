...
public class SwerveSubsystem extends SubsystemBase {
    ...
    private final SwerveDrivePoseEstimator robotPoseEstimator =
    ...
    public void zeroRobotHeading() {
        robotPoseEstimator.resetPosition(
                getRotation2d(),
                getModulePositions(),
                new Pose2d(
                        robotPoseEstimator.getEstimatedPosition().getX(),
    ...
    public void runModulesFieldRelative(double xSpeed, double ySpeed, double turningSpeed) {
        ...
        ChassisSpeeds chassisSpeeds =
                ChassisSpeeds.fromFieldRelativeSpeeds(
                        ...
                        ySpeed,
                        turningSpeed,
                        robotPoseEstimator.getEstimatedPosition().getRotation());
    ...
    public void periodic() {
        ...
        robotPoseEstimator.updateWithTime(
                MathSharedStore.getTimestamp(), getRotation2d(), getModulePositions());
