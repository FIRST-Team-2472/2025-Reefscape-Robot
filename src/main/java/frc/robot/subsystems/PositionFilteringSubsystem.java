...
public class PositionFilteringSubsystem extends SubsystemBase {
	...
	public Pose2d getFilteredBotPose(SwerveDriveOdometry odometer, double odometryConfidence) {
		...
		for (int i = 0; i < numLimeLights; i++) {
			/*
			 * System.out.println("PositionFilteringSubsystem: Confidence: " +
			 * limeLightConfidences[i] + ", Pose: (" + limeLightBotPoses[i].getX() + ", " +
			 * limeLightBotPoses[i].getY() + ")");
			 */
		}
		...
		// System.out.println("PositionFilteringSubsystem: Original Confidences: " +
		// Arrays.toString(confs));
		...
		if (totalConfidence == 0.0d) {
			// System.out.println("PositionFilteringSubsystem: Total Confidence is 0,
			// returning odometry
			// pose");
			return odometryBotPose;
		}

		// System.out.println("PositionFilteringSubsystem: Total Confidence: " +
		// totalConfidence);
		...
		// System.out.println("PositionFilteringSubsystem: Normalized Confidences: " +
		// Arrays.toString(confs));
		...
		for (int i = 0; i < numLimeLights; i++) {
			...
			/*
			 * System.out.println("PositionFilteringSubsystem: LimeLightBotPose[" + i +
			 * "].X: " + limeLightBotPoses[i].getX() + ", Confidence: " + confs[i + 1]);
			 */
			weightedY += limeLightBotPoses[i].getY() * confs[i + 1];
			/*
			 * System.out.println("PositionFilteringSubsystem: LimeLightBotPose[" + i +
			 * "].Y: " + limeLightBotPoses[i].getY() + ", Confidence: " + confs[i + 1]);
			 */
		...
		/*
		 * System.out.println("PositionFilteringSubsystem: OdometryBotPose.X: " +
		 * odometryBotPose.getX() + ", Confidence: " + confs[0]);
		 * System.out.println("PositionFilteringSubsystem: OdometryBotPose.Y: " +
		 * odometryBotPose.getY() + ", Confidence: " + confs[0]);
		 */
