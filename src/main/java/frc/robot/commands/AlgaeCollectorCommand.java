...
public class AlgaeCollectorCommand extends Command {
    ...
    public AlgaeCollectorCommand(AlgaeCollectionSubsystem algaeCollectionSubsystem) {
        ...
        motorPowerController =
                new MotorPowerController(0.03, 0.3, 0.2, 0.3, 1, SensorStatus.kClimberAngle, 5);
    ...
    @Override
    public void execute() {
        algaeCollectionSubsystem.runPivotMotor(
                motorPowerController.calculate(30, SensorStatus.kPivotAngle));
