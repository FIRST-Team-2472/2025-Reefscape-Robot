...
public class ElevatorCommand extends Command {
  ...
  public ElevatorCommand(
    ...
    elevatorMotorMotorPowerController =
        new MotorPowerController(0.0001, 0.0001, 0.0001, 10, 0, SensorStatus.kElevatorHeight, 0);
  }
  ...
  public void execute() {
    ...
    elevatorSubsystem.runElevatorMotor(
        elevatorMotorMotorPowerController.calculateMotorPowerController(
