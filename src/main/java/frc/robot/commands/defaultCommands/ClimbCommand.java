...
public class ClimbCommand extends Command {
    ...
    MotorPowerController climberMotorPowerController =
            new MotorPowerController(0.0001, 0.0001, 0.0001, 1, 0, RobotStatus.kClimberAngle, 0);
        ...
        if (anglingIn) {
            y =
                    climberMotorPowerController.calculate(
                            ClimberConstants.kClimberInAngle, RobotStatus.kClimberAngle);
        }
        if (anglingOut) {
            y =
                    climberMotorPowerController.calculate(
                            ClimberConstants.kClimberOutAngle, RobotStatus.kClimberAngle);
        }
