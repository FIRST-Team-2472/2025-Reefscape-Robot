...
public class CoralDispenserCommand extends Command {
  ...
  public CoralDispenserCommand(
      CoralDispenserSubsytem coralDispenserSubsytem, Supplier<Boolean> xboxControllerRightTrigger) {
  ...
  @Override
  public void execute() {
    if (xboxControllerRightTrigger.get()) coralDispenserSubsytem.runMotors(1, -1);
  }
