...
public class I2CUtil implements AutoCloseable {
  ...
  public synchronized boolean transaction(
      byte[] dataToSend, byte sendSize, byte[] dataReceived, byte receiveSize) {
    ...
    return I2CJNI.i2CTransactionB(port, devAddr, dataToSend, sendSize, dataReceived, receiveSize)
        >= 0;
  }
