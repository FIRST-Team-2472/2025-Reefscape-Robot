...
public class RobotContainer {
    ...
    private final String HToSit = "Drive To H and Sit",
    ...
    private final String coralcollectionautotest = "Test Coral Collection - TEST FIRST!!!",
    ...
    public RobotContainer() {
        ...
        ShuffleboardTab autoTestingBoard = Shuffleboard.getTab("Auto Testing");
        autoTestingBoard
                .add("Auto choices - in testing", testChooser)
                .withWidget(BuiltInWidgets.kComboBoxChooser);
    ...
    public Command getAutonomousCommand() {
        ...
        if (m_autoSelected != null) {
            switch (m_autoSelected) {
                case HToSit:
                    return new SequentialCommandGroup(commandSequences.StartToH(swerveSubsystem));
