...
public final class Constants {
	 ...
	 *
	 * <p>
	 * currentLogLevel: The current logging level for the robot's logging system.
	 * The log level determines the severity of messages that will be logged. Common
	 * log levels include DEBUG, INFO, WARN, and ERROR, with DEBUG being the most
	...
	public static final class ElevatorConstants {
		...
		public static final double kElevatorGearRatio = 1.0 / 20; // 20 rotations of the motor to one shaft rotation the
																	// 1.0 is so it does decimal
		// not integer division
		public static final double kSprocketCircumference = 5.538628; // slightly rounded and in inches
		public static final double kElevatorMotorRotationsToInches = kSprocketCircumference * kElevatorGearRatio * -2; // times
																														// two
																														// because
																														// its
																														// a
	...
	public static final class TeleDriveConstants {
		...
		public static final double kMaxSpeedMetersPerSecond = DriveConstants.kPhysicalMaxSpeedMetersPerSecond / 1; // used
																													// to
																													// be
																													// /4
	...
	public static final class AutoConstants {
		...
		public static final double kMaxSpeedMetersPerSecond = DriveConstants.kPhysicalMaxSpeedMetersPerSecond / 9.44; // was
																														// 9.44;
																														// (changed
																														// 2/20/25)//was
																														// 4
		...
		/*
		 * PathPlanner Holonomic Controller - Not used anymore public static final
		 * PPHolonomicDriveController HOLONOMIC_PATH_FOLLOWER_CONFIG = new
		 * PPHolonomicDriveController( new PIDConstants( TRANSLATION_KP, TRANSLATION_KI,
		 * TRANSLATION_KD), // Translation PID constants new PIDConstants( ROTATION_KP,
		 * ROTATION_KI, ROTATION_KD) //Time between code runs );
		 */
	}

	public static final class TargetPosConstants {
		// Motion constants for target position drive mode
		public static final double kMaxSpeedMetersPerSecond = DriveConstants.kPhysicalMaxSpeedMetersPerSecond / 1; // was
																													// 4
																													// (changed
																													// 2/20/25);
