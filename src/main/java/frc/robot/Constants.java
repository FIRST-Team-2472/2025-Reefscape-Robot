...
public final class Constants {
  ...
  public static final class ElevatorConstants {
    ...
    public static final double kElevatorGearRatio =
        1 / 20; // 20 rotations of the motor to one shaft rotation
  ...
  public static final class ModuleConstants {
    ...
    public static final double kDriveEncoderRot2Meter =
        kDriveMotorGearRatio * Math.PI * kWheelDiameterMeters * (1.0 / 2048.0) * 0.9402;
    public static final double kTurningEncoderRot2Rad =
        kTurningMotorGearRatio * 2 * Math.PI * (1.0 / 2048.0);
  ...
  public static final class SensorConstants {
    ...
    public static int kMiddleLimitSwitchID =
        1; // set later it will break if they are the same number
