...
public final class Constants {
   ...
   * determines the severity of messages that will be logged. Common log levels include DEBUG, INFO,
   * WARN, and ERROR, with DEBUG being the most verbose and ERROR being the least.
   */
  ...
  public static final class ElevatorConstants {
    ...
    public static final double kElevatorGearRatio =
        1.0 / 20; // 20 rotations of the motor to one shaft rotation the 1.0 is so it does decimal
    ...
    public static final double kElevatorMotorRotationsToInches =
        kSprocketCircumference
            * kElevatorGearRatio
            * -2; // times two because its a two stage elevator negative because the encoder reads
  ...
  public static final class AutoConstants {
    ...
    public static final double kMaxSpeedMetersPerSecond =
        DriveConstants.kPhysicalMaxSpeedMetersPerSecond
            / 9.44; // was 9.44; (changed 2/20/25)//was 4 before 9.44 (changed somtime before
    // 2/20/25)
    public static final double kMaxAngularSpeedRadiansPerSecond = //
