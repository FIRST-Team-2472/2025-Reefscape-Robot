...
public final class Constants {
    ...
    public static final class ElevatorConstants {
        ...
        public static final double kElevatorGearRatio =
                1.0 / 20; // 20 rotations of the motor to one shaft rotation the
        ...
        public static final double kElevatorMotorRotationsToInches =
                kSprocketCircumference * kElevatorGearRatio * -2; // times
        // two
        // because
        // its
        // a
    ...
    public static final class TeleDriveConstants {
        ...
        public static final double kMaxSpeedMetersPerSecond =
                DriveConstants.kPhysicalMaxSpeedMetersPerSecond / 1; // used
        // to
        // be
        // /4
    ...
    public static final class AutoConstants {
        ...
        public static final double kMaxSpeedMetersPerSecond =
                DriveConstants.kPhysicalMaxSpeedMetersPerSecond / 9.44; // was
        // 9.44;
        // (changed
        // 2/20/25)//was
        // 4
    ...
    public static final class TargetPosConstants {
        ...
        public static final double kMaxSpeedMetersPerSecond =
                DriveConstants.kPhysicalMaxSpeedMetersPerSecond / 1; // was
        // 4
        // (changed
        // 2/20/25);
